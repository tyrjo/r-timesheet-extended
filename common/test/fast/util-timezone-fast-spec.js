describe("When using timezone utilities", function() {
    ...
    it("given a date in a local timezone, should provide a sunday iso string without timestamp",function(){
        ...
        expect(TSDateUtils.getUtcIsoForLocalDate(sunday_local)).toEqual(sunday_iso);
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local)).toEqual(sunday_iso);
        expect(TSDateUtils.getUtcIsoForLocalDate(friday_local)).toEqual(sunday_iso);
        expect(TSDateUtils.getUtcIsoForLocalDate(friday_local, false)).toEqual(sunday_iso);
    });
    ...
    it("given a date in a local timezone that matches Sunday in UTC, should provide a sunday iso string without timestamp",function(){
        ...
        expect(TSDateUtils.getUtcIsoForLocalDate(sunday_in_utc)).toEqual(sunday_iso);
    });
    ...
    it("given a date in a local timezone, should provide a sunday iso string with fake midnight timestamp",function(){
        ...
        expect(TSDateUtils.getUtcIsoForLocalDate(sunday_local,true)).toEqual(sunday_iso);
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local,true)).toEqual(sunday_iso);
        expect(TSDateUtils.getUtcIsoForLocalDate(friday_local,true)).toEqual(sunday_iso);
    });
    ...
    it("given a date in a local timezone that matches Sunday in UTC, should provide a sunday iso string with fake midnight timestamp",function(){
        ...
        expect(TSDateUtils.getUtcIsoForLocalDate(sunday_in_utc,true)).toEqual(sunday_iso);
    });
    ...
    it ("given a date in local timezone, provide the exact same date with a UTC timestamp", function() {
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local)).toEqual(monday_in_utc);
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local_DST)).toEqual(monday_in_utc_DST);
    });
    
        
    it ("given a date in local timezone, provide the exact same date as ISO but with a UTC timestamp", function() {
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local,true)).toEqual("2016-02-08T00:00:00.000Z");
        expect(TSDateUtils.getUtcIsoForLocalDate(monday_local_DST,true)).toEqual("2016-03-14T00:00:00.000Z");
    });
});
